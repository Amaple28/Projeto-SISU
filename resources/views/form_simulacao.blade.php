...
<form action="{{route('dashboard')}}" method="get">
  ...
  <div class="container-fluid text-center">
    <div class="row">
      ...
      <div class="form-floating col-12 col-md-6 mb-3 lado_direito">
        ...
        <label for="floatingSelect">Estado onde mora:</label>
      </div>

      <div class="col-12 col-md-6 mb-3 faculdades container">
        <h6>Selecione 3 faculdades:</h6>
        <div class="container-fluid text-center">
          <div class="row">
            @foreach ($faculdades as $faculdade)
              <div class="col-6 col-mb-6">
