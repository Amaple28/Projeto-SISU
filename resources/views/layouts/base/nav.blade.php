...
<nav class="navbar navbar-light bg-warning">
    <div class="container-fluid">
        ...
        @if (Auth::check())
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
                    ...
                    <div class="offcanvas-body body-nav">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            @if ($user->tipo_user == 1)
                                {{-- opções que somente o administrador tem acesso --}}
                                <li class="nav-item">
                            ...
                            @else
                                {{-- opções que somente o user tem acesso --}}
                                ...
                                <li class="nav-item mb-2">
                                    <a class="nav-link" data-bs-toggle="modal" data-bs-target="#modal" href="#"
                                        onclick="yourEditNavuser(this)">
            ...
            {{-- modal alterar senha --}}
            <div class="modal fade" id="exampleSenha" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            {{-- modal excluir conta do user --}}
            <div class="modal fade" id="deletarUser" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form method="post" action="{{ route('deletar-usuario') }}">
                            <div class="modal-body">
                                @csrf
                                <div class="form-group mb-3 senha">
                                    <h6 for="password_excluir">Tem certeza que gostaria de excluir sua conta? <br>(Se
                                        sim, digite sua senha para confirmar)</h6>

                                    <input type="password" class="form-control" name="password_excluir"
                                        id="password_excluir" placeholder="">
            ...
            {{-- modal de informaçoes importantes --}}
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group mb-3 atento">
                                ...
                                <p>As notas de corte utilizadas no simulador foram obtidas através do portal <a
                                        href="https://sisu.mec.gov.br/#/relatorio#onepage" target="_blank">SISU MEC
                                        RELÁTORIOS</a> , para obter todas as informações sobre as notas utilizadas,
                                    acesse ao link e faça download dos relatórios correspondentes.</p>
                                <p>O Simulador SISUMED não garante aprovação do usuário ao processo do SISU, os seus
                                    valores tem como objetivo ser uma referência para que o usuário possa analisar as
                                    possibilidades, quem garantirá o processo de ingresso a uma universidade será a
                                    ultima nota de corte calculada pelo processo seletivo do SISU, sendo esta nota de
                                    inteira responsábilidade do Sistema de Seleção Unificada - SISU 2023.</p>
                                <h6>2. Sobre a Modalidade</h6>
                                <p>As notas de cortes apresentadas para a modalidade de cota foi obtida utilizando o
                                    critério de selecionar a maior nota de corte entre as modalidades que possuem uma
                                    maior oferta de vagas, caso deseje saber todas as notas para cada tipo de
                                    modalidade, acesso ao <a href="https://sisu.mec.gov.br/#/relatorio#onepage"
                                        target="_blank">link</a> e baixe o relatório correspondente.</p>
                                <h6>3. Sobre o Estado</h6>
                                <p>Esta informação será utilizada para cálculo do bônus regional oferecido por algumas
...
<script>
    // scripts que chamam as funções dos seus respectivos modais
    ...
    // icon de olho para mostrar senha ou esconder senha no modal de redefinir senha do user
    // input nova senha do modal de redefinir senha do use
    ...
    // input confirmar nova senha do modal de redefinir senha do user
    ...
    // input senha atual do modal de redefinir senha do user
    ...
    // input do modal de deletar user
