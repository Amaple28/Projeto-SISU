    ...
    @foreach($faculdades_escolhidas as $faculdade_escolhida)
        <div class="col-10 mb-3">
            ...
            <div class="collapse show" id="collapsecard{{$faculdade_escolhida->id}}">
                <div class="card @if($faculdade_escolhida->getsisu_atual()==0) zerada @elseif(!$faculdade_escolhida->getCalculoAnterior($user->id, $estado)) reprovado @elseif ($faculdade_escolhida->getCalculoAnterior($user->id, $estado) == 'zero') zerada  @else aprovado @endif">
                    <div class="card-body">
