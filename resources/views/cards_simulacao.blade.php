        ...
        <div class="col-10 mb-3">
            ...
            <div class="collapse show" id="collapsecard{{$faculdade_escolhida->id}}">
                <div class="card  @if(!$faculdade_escolhida->getCalculoAnterior($user->id, $estado))reprovado @else aprovado @endif">
                    <div class="card-body">
                        <h5 class="card-title mb-3">{{$faculdade_escolhida->estado}} - {{$faculdade_escolhida->nome}} {{$faculdade_escolhida->endereco}} ({{$faculdade->modalidade}})</h5>
                        ...
                        <div class="quadro_resultado">
                            <div class="col-12">
                                <p class="text-muted chances">
                                    ...
                                    Nota final abaixo da nota de corte. Nota:{{$faculdade_escolhida->getCalculaNotaUserFacul($user->id,$estado)}}
                                    <i class="fas fa-frown"></i>
                                    @else
                                    <i class="fas fa-long-arrow-alt-up"></i>
                                    Nota final acima da nota de corte. Nota:{{$faculdade_escolhida->getCalculaNotaUserFacul($user->id,$estado)}}
