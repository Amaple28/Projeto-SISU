...
<form method="POST" action="/criar-usuario">
    ...
    {{-- notas informadas no formulário de notas do enem --}}
    <input type="number" hidden class="form-control resultadoMatematica" id="matematicaR" name="matematicaR"
        min="0" max="1000" step="0.1" placeholder="000.0">
    <input type="number" hidden class="form-control resultadoHumanas" id="humanasR" name="humanasR" min="0"
        max="1000" step=".1" placeholder="000.0">
    <input type="number" hidden class="form-control resultadoNatureza" id="naturezaR" name="naturezaR" min="0"
        max="1000" step=".1" placeholder="000.0">
    <input type="number" hidden class="form-control resultadoLinguagens" id="linguagensR" name="linguagensR"
        min="0" max="1000" step=".1" placeholder="000.0">
    <input type="number" hidden class="form-control resultadoRedacao" id="redacaoR" name="redacaoR" min="0"
        max="1000" step=".1" placeholder="000.0">

    {{-- check box para aceitar a politica de privacidade --}}
    <div class="form-check mb-3">
        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" required>
        <label class="form-check-label privacidade" for="flexCheckDefault">
            Li e aceito a <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal">Política de
                Privacidade</a>
        </label>
    </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include('index.politica_privacidade')
            </div>
...
{{-- script --}}
<script>
    // esconder ou nao o campo de senha no cadastro
...
{{-- script para o modal de politica de privacidade --}}
<script>
